                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {data?.map((element: any, index: any) => (
                                            <tr key={index}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap border">
                                                    <div
                                                        className="text-left text-sm text-gray-900 font-bold">{new Date(element?.take_off_date).toLocaleString('en-us', {
                                                            year: 'numeric',
                                                            day: 'numeric',
                                                            month: 'long'
                                                        })}</div>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap border">
                                                    <div
                                                        className="text-left text-sm text-gray-900 font-bold">{new Date(element?.destination_date).toLocaleString('en-us', {
                                                            year: 'numeric',
                                                            day: 'numeric',
                                                            month: 'long'
                                                        })}</div>
